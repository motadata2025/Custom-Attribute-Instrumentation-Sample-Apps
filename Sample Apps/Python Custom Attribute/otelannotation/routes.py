"""
API routes and controllers with OpenTelemetry instrumentation

OOP-BASED IMPLEMENTATION - Uses UserService instance
ANNOTATION-ONLY - All service methods use @decorator (create NEW spans)
"""
...
# Create a single instance of UserService (OOP approach)
...
def get_users():
    ...
    """
    # Uses service instance with @decorator (creates NEW span)
...
def get_user(username):
    """
    Get a specific user by username with enrichment
    ---
    tags:
      - Users
    parameters:
...
def create_user():
    ...
    # Uses service instance that creates NEW spans (nested under HTTP span)
...
def update_user(username):
    """
    Update an existing user with change tracking
    ---
    tags:
      - Users
    parameters:
        ...
        schema:
          ...
          properties:
            error:
              type: string
    """
    # Uses service instance that creates NEW span (nested under HTTP span)
