-- -- Create the nodejs_user_tbl table
-- CREATE TABLE IF NOT EXISTS nodejs_user_tbl (
...
-- CREATE INDEX IF NOT EXISTS idx_username ON nodejs_user_tbl(username);
--
...
-- DROP TRIGGER IF EXISTS update_nodejs_user_tbl_updated_at ON nodejs_user_tbl;
-- CREATE TRIGGER update_nodejs_user_tbl_updated_at
--     BEFORE UPDATE ON nodejs_user_tbl
--     FOR EACH ROW
